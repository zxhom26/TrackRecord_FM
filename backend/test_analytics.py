...
class TestUserAnalytics(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        self.sample_top_tracks = {
            "items": [
                {"id": "track1", "name": "Song1", "popularity": 55},
                {"id": "track2", "name": "Song2", "popularity": 60}
            ]
        }
